    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'Friends Car Rental', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                ...
                'class' => '', // any class for input
                'value' => '<a href="https://www.vpninfotech.com/" class="text-muted">Built with ♥ from VPN Infotech</a>', // default value if you want
            ],
            [
    ...
    'meta' => [
        ...
        'elements' => [
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'img/fcr-logo.png', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'rules' => 'required|max:300', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '', // default value if you want
            ],
            [
                'type' => 'text', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'name' => 'phone_no', // unique name for field
            ...
            [
                'type' => 'text', // input fields type
                'data' => 'text', // data type, string, int, boolean
                'name' => 'embeded_map_url', // unique name for field
                'label' => 'Map', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '', // default value if you want
            ],
            [
                'type' => 'email', // input fields type
                'data' => 'string', // data type, string, int, boolean
                'name' => 'admin_email', // unique name for field
                'label' => 'Admin Email', // you know what label it is
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => '', // default value if you want
            ],
