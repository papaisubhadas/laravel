            ...
            <div class="col">
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            <th>
                                {{__('notification.notifications.index.text');}}
                            </th>
                            <th>
                                {{__('notification.notifications.index.module');}}
                            </th>
                            <th>
                                {{__('notification.notifications.index.updated_at');}}
                            </th>
                            <th class="text-end">
                                {{__('notification.notifications.index.action');}}
                            </th>
                        </tr>
                    </thead>
