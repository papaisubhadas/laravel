...
<header class="header header-sticky mb-4">
    <div class="container-fluid">
        ...
        <a class="header-brand d-md-none" href="#">
            <img class="sidebar-brand-full" src="{{asset("img/fcr-logo.png")}}" height="46" alt="{{ app_name() }}">
        </a>
        <ul class="header-nav d-none d-md-flex">
            <li class="nav-item"><a class="nav-link" href="{{ route('frontend.home') }}" target="_blank">{{app_name()}}&nbsp;<i class="fa-solid fa-arrow-up-right-from-square"></i></a></li>
        </ul>
        ...
        <ul class="header-nav ms-3">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link py-0" data-coreui-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
                    <div class="avatar avatar-md" style="margin-top: 10px;">
                        <img class="avatar-img" src="{{ asset(auth()->user()->avatar) }}" alt="{{ asset(auth()->user()->name) }}" style="height: 100% !important;">
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end pt-0">
                    <div class="dropdown-header bg-light py-2">
                   ...
                   {{-- <a class="dropdown-item" href="{{ route("backend.notifications.index") }}">
                    ...
                    <div class="dropdown-header bg-light py-2"><strong>@lang('Setting')</strong></div>
