...
<x-backend-breadcrumbs>
    ...
    <x-backend-breadcrumb-item type="active">{{ __('common.profile_title') }}</x-backend-breadcrumb-item>
</x-backend-breadcrumbs>
@endsection
...
<div class="card">
    <div class="card-body">
        <x-backend.section-header>
            <i class="{{ $module_icon }}"></i> {{ __('common.profile_title') }} <small class="text-muted">{{ __($module_action) }}</small>
