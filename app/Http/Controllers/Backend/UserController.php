...
class UserController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = 'common.user_title';
    ...
    public function store(Request $request)
    {
        ...
        $module_action = __('common.details');
    ...
    public function profile(Request $request, $id)
    {
        ...
        $module_action = __('common.profile_show');
    ...
    public function profileEdit($id)
    {
        ...
        $module_action = __('common.edit_profile');
    ...
    public function changeProfilePasswordUpdate(Request $request, $id)
    {
        ...
        Flash::success(icon() . " " . Str::singular(__($module_title)) . " Updated Successfully")->important();
    ...
    public function changePassword($id)
    {
        ...
        $module_action = __('common.change_password');
    ...
    public function trashed()
    {
        ...
        $module_action = __('common.deleted_list');
    ...
    public function unblock($id)
    {
        ...
        $module_action = __('common.unblock');
