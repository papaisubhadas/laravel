...
<div class="row mb-3">
    ...
    <div class="col">
        <div class="form-group">
            <?php
            $field_name = 'user_id';
            $field_lable = __('comment.comments.create.user');
            $field_relation = "user";
    ...
    <div class="col">
        <div class="form-group">
            ...
            $field_lable = __('comment.comments.create.parent_comment');
...
<div class="row mb-3">
    <div class="col-12 col-md-6">
        <div class="form-group">
            <?php
            $field_name = 'name';
            $field_lable = __('comment.comments.create.name');
    ...
    <div class="col-6 col-md-4">
        <div class="form-group">
            <?php
            $field_name = 'slug';
            $field_lable = __('comment.comments.create.slug');
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
    ...
    <div class="col-6 col-md-2">
        <div class="form-group">
            <?php
            $field_name = 'order';
            $field_lable = __('comment.comments.create.order');
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
...
<div class="row mb-3">
    <div class="col-12">
        <div class="form-group">
            <?php
            $field_name = 'comment';
            $field_lable = __('comment.comments.create.comment');
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
...
<div class="row mb-3">
    <div class="col-4">
        <div class="form-group">
            <?php
            $field_name = 'status';
            $field_lable = __('comment.comments.create.status');
            $field_placeholder = "-- Select an option --";
            $required = "required";
            $select_options = [
                '0'=>'Pending',
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            $field_lable = __('comment.comments.create.moderated_at');
            $field_placeholder = $field_lable;
            $required = "";
    ...
    <div class="col-4">
        <div class="form-group">
            ...
            $field_lable = __('comment.comments.create.published_at');
            $field_placeholder = $field_lable;
            $required = "";
