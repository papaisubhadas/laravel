            ...
            <div class="col">
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            <th>
                                @lang("bannerslideshow::text.id")
                            </th>
                            <th>
                                @lang("bannerslideshow::text.title")
                            </th>
                            <th>
                                @lang("bannerslideshow::text.image")
                            </th>
                            <th>
                                @lang("bannerslideshow::text.updated_at")
                            </th>
                            <th>
                                @lang("bannerslideshow::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("bannerslideshow::text.action")
                            </th>
                        </tr>
                    </thead>
