            ...
            <div class="col-12">
                ...
                <table class="table table-responsive-sm table-hover table-bordered">
                    ...
                    <tr>
                        ...
                        <td>
                            @if(App::currentLocale() == 'en')
                                {{ (isset($$module_name_singular) && $$module_name_singular->translate('en')) ? $$module_name_singular->translate('en')->title : '' }}
                            @elseif(App::currentLocale() == 'ar')
                                {{ (isset($$module_name_singular) && $$module_name_singular->translate('ar')) ? $$module_name_singular->translate('ar')->title : '' }}
                            @elseif(App::currentLocale() == 'fr')
                                {{ (isset($$module_name_singular) && $$module_name_singular->translate('fr')) ? $$module_name_singular->translate('fr')->title : '' }}
                            @elseif(App::currentLocale() == 'ru')
                                {{ (isset($$module_name_singular) && $$module_name_singular->translate('ru')) ? $$module_name_singular->translate('ru')->title : '' }}
                            @endif
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            @if(App::currentLocale() == 'en')
                                {{ (isset($$module_name_singular) && $$module_name_singular->translate('en')) ? $$module_name_singular->translate('en')->sub_title : '' }}
                            @elseif(App::currentLocale() == 'ar')
                                {{ (isset($$module_name_singular) && $$module_name_singular->translate('ar')) ? $$module_name_singular->translate('ar')->sub_title : '' }}
                            @elseif(App::currentLocale() == 'fr')
                                {{ (isset($$module_name_singular) && $$module_name_singular->translate('fr')) ? $$module_name_singular->translate('fr')->sub_title : '' }}
                            @elseif(App::currentLocale() == 'ru')
                                {{ (isset($$module_name_singular) && $$module_name_singular->translate('ru')) ? $$module_name_singular->translate('ru')->sub_title : '' }}
                            @endif
                        </td>
                    ...
                    @for($i=1 ;$i < sizeof($all_columns) - 6;$i++)
                        <tr>
                            ...
                            <td>
                                ...
                                @if($all_columns[$i]->Field == 'image' && !empty($image))
