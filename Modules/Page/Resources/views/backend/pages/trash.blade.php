                  ...
                  <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <strong>
                                    {{ $module_name_singular->page_title }}
                                </strong>
                            </td>
                            <td>
                            ...
                            <td class="text-end">
                                <a href="{{route("backend.$module_name.restore", $module_name_singular)}}" class="btn btn-warning btn-sm" data-method="PATCH" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('page::labels.backend.restore')}}"><i class='fas fa-undo'></i> {{__('page::labels.backend.restore')}}</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
