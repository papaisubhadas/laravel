...
<div class="row mb-3">
    <div class="tabs_c tabs_c2">
        <ul class="tabs_c-list">
            <li class="active outer-tab"><a href="#general">{{ __('cartype.general') }}</a></li>
            <li class="outer-tab"><a href="#seo_section">{{ __('cartype.seo_section') }}</a></li>
        ...
        <div id="general" class="tab active outer-tab-cont">
            <br/>
            <div class="row mb-3">
                <p><strong>{{__('cartype.note')}}</strong> {{__('cartype.You_must_enter')}}
                    <strong>{{__('cartype.title')}}</strong> {{__('cartype.and')}}
                    <strong>{{__('cartype.description')}}</strong> {{__('cartype.submit_text')}}</p>
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <?php
                                    $field_name = 'title_en';
                                    $field_lable = __('cartype.cartypes.create.title');
                                    $field_placeholder = __('cartype.cartypes.create.title');
                                    $required = "required";
                                    ?>
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    ...
                                    $field_lable = __('cartype.cartypes.create.custom_title');
                                    $field_placeholder = $field_lable;
                                    $required = "required";
                                    ?>
                                    {{ html()->label($field_lable, $field_lable)->class('form-label') }} {!! fielf_required($required) !!}
                                    {{ html()->text($field_name)->placeholder($field_placeholder)->class('form-control')->value($custom_title_en) }}
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <?php
                                    $field_name = 'slug';
                                    $field_lable = __('cartype.cartypes.create.slug');
                                    $field_placeholder = __('cartype.cartypes.create.slug');
                                    $required = "required";
                                    ?>
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <?php
                                    $field_name = 'status';
                                    $field_lable = __('cartype.cartypes.create.status');
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    $field_lable = __('cartype.cartypes.create.description');
                                    $field_placeholder = __('cartype.cartypes.create.description');
                                    $required = "required";
                                    ?>
                                    {{ html()->label($field_lable, $field_lable)->class('form-label') }} {!! fielf_required($required) !!}
                                    {{ html()->textarea($field_name)->placeholder($field_placeholder)->class('form-control content')->value($description_en) }}
                                </div>
                            </div>
                        </div>

                        @if(isset($image) && file_exists(public_path('frontend/image/'.$image)))
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="form-group">
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="form-group">
                                    <?php
                                    $field_name = 'image';
                                    $field_lable = __('cartype.cartypes.create.car_type_image');
                                    $field_placeholder = $field_lable;
                    ...
                    <div id="general_ar" class="tab inner-tab-cont">
                        ...
                        <div class="col-12 col-sm-4">
                            <div class="form-group">
                                ...
                                $field_lable = __('cartype.cartypes.create.custom_title');
                                $field_placeholder = __('cartype.cartypes.create.custom_title');
                                $required = "required";
                                ?>
                                {{ html()->label($field_lable, $field_lable)->class('form-label') }} {!! fielf_required($required) !!}
                                {{ html()->text($field_name)->placeholder($field_placeholder)->class('form-control')->value($custom_title_ar) }}
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    ?>
                                    {{ html()->label($field_lable, $field_lable)->class('form-label') }} {!! fielf_required($required) !!}
                                    {{ html()->textarea($field_name)->placeholder($field_placeholder)->class('form-control content')->value($description_ar) }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="general_fr" class="tab inner-tab-cont">
                        ...
                        <div class="col-12 col-sm-4">
                            <div class="form-group">
                                ...
                                ?>
                                {{ html()->label($field_lable, $field_lable)->class('form-label') }} {!! fielf_required($required) !!}
                                {{ html()->text($field_name)->placeholder($field_placeholder)->class('form-control')->value($custom_title_fr) }}
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    ?>
                                    {{ html()->label($field_lable, $field_lable)->class('form-label') }} {!! fielf_required($required) !!}
                                    {{ html()->textarea($field_name)->placeholder($field_placeholder)->class('form-control content')->value($description_fr) }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="general_ru" class="tab inner-tab-cont">
                        ...
                        <div class="col-12 col-sm-4">
                            <div class="form-group">
                                ...
                                ?>
                                {{ html()->label($field_lable, $field_lable)->class('form-label') }} {!! fielf_required($required) !!}
                                {{ html()->text($field_name)->placeholder($field_placeholder)->class('form-control')->value($custom_title_ru) }}
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    ?>
                                    {{ html()->label($field_lable, $field_lable)->class('form-label') }} {!! fielf_required($required) !!}
                                    {{ html()->textarea($field_name)->placeholder($field_placeholder)->class('form-control content')->value($description_ru) }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="seo_section_en" class="tab active inner-tab-cont">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="form-label" for="meta_title">{{ __('cartype.meta_title') }}</label>
                                    <input class="form-control" type="text" name="meta_title_en" id="meta_keyword"
                                           placeholder="{{ __('cartype.meta_title') }}" value="{{$meta_title_en}}">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label class="form-label"
                                           for="meta_keyword">{{ __('cartype.meta_keywords') }}</label>
                                    <input class="form-control" type="text" name="meta_keyword_en" id="meta_keyword_en"
                                           placeholder="{{ __('cartype.meta_keywords') }}"
                                           value="{{$meta_keyword_en}}">
                                </div>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    <label class="form-label"
                                           for="meta_description">{{ __('cartype.meta_description') }}</label>
                                    <textarea class="form-control" type="text" name="meta_description_en"
                                              id="meta_description_en"
                                              placeholder="{{ __('cartype.meta_description') }}">{{$meta_description_en}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 mb-3">
                            <div class="form-group">
                                ...
                                @if(file_exists(public_path("frontend/Feature/CarType/".$feature_image_en)))
                                <div class="image-thumbnain-wrapper">
                                    @if(!empty($feature_image_en))<img class="imageThumb ml10 " src="{{ url("frontend/Feature/CarType/".$feature_image_en) }}" width="130" alt="1029">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="meta_title_ar" id="meta_keyword"
                                           placeholder="{{ __('cartype.meta_title') }}" value="{{$meta_title_ar}}">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" type="text" name="meta_description_ar"
                                              ...
                                              placeholder="{{ __('cartype.meta_description') }}">{{$meta_description_ar}}</textarea>
                                </div>
                            </div>
                        </div>
                        <br>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="meta_title_fr" id="meta_keyword_fr"
                                           placeholder="{{ __('cartype.meta_title') }}" value="{{$meta_title_fr}}">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" type="text" name="meta_description_fr"
                                              ...
                                              placeholder="{{ __('cartype.meta_description') }}n">{{$meta_description_fr}}</textarea>
                                </div>
                            </div>
                        </div>
                        <br>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="meta_title_ru" id="meta_keyword_ru"
                                           placeholder="{{ __('cartype.meta_title') }}" value="{{$meta_title_ru}}">
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" type="text" name="meta_description_ru"
                                              ...
                                              placeholder="{{ __('cartype.meta_description') }}n">{{$meta_description_ru}}</textarea>
                                </div>
                            </div>
                        </div>
                        <br>
    ...
    <script>
        $(document).ready(function () {
            $(document).on("click", "#feature-image-delete", function() {
                swal({
                    title: '',
                    text: '{{ __('cartype.feature_image_delete') }}',
                    type: 'warning',
                    showCancelButton: true,
                    closeOnConfirm: false,
                    showLoaderOnConfirm: false,
                ...
                function () {
                    ...
                    $.ajax({
                        type: "get",
                        url: "{{ route('backend.cartypes.delete',$$module_name_singular->id) }}",
                        success: function (response) {
    ...
    <script>
        $(document).ready(function () {
            $(document).on("click", "#delete-details", function() {
                swal({
                    title: '',
                    text: '{{ __('cartype.delete_permanently') }}',
                    type: 'warning',
                    showCancelButton: true,
                    closeOnConfirm: false,
                    showLoaderOnConfirm: false,
                ...
                function () {
                        ...
                        $.ajax({
                            type: "post",
                            url: "{{ route('backend.cartypes.delete_details',$$module_name_singular->id) }}",
                            success: function (response) {
                                swal.close();
