                ...
                <div class="col-12">
                    ...
                    <table class="table table-responsive-sm table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif(App::currentLocale() == 'ar')
                                    {{ (isset($$module_name_singular) && $$module_name_singular->translate('ar')) ? $$module_name_singular->translate('ar')->name : '' }}
                                @elseif(App::currentLocale() == 'fr')
                                    {{ (isset($$module_name_singular) && $$module_name_singular->translate('fr')) ? $$module_name_singular->translate('fr')->name : '' }}
                                @elseif(App::currentLocale() == 'ru')
                                    {{ (isset($$module_name_singular) && $$module_name_singular->translate('ru')) ? $$module_name_singular->translate('ru')->name : '' }}
                                @endif
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                @if(App::currentLocale() == 'en')
                                    {{ (isset($$module_name_singular) && $$module_name_singular->translate('en')) ? $$module_name_singular->translate('en')->comment : '' }}
                                @elseif(App::currentLocale() == 'ar')
                                    {{ (isset($$module_name_singular) && $$module_name_singular->translate('ar')) ? $$module_name_singular->translate('ar')->comment : '' }}
                                @elseif(App::currentLocale() == 'fr')
                                    {{ (isset($$module_name_singular) && $$module_name_singular->translate('fr')) ? $$module_name_singular->translate('fr')->comment : '' }}
                                @elseif(App::currentLocale() == 'ru')
                                    {{ (isset($$module_name_singular) && $$module_name_singular->translate('ru')) ? $$module_name_singular->translate('ru')->comment : '' }}
                                @endif
                            </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @if($all_columns[$i]->Field == 'image')
                                        @if(file_exists(public_path("frontend/testimonial/$image")))
