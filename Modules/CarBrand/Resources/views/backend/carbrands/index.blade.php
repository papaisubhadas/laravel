            ...
            <div class="col">
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            <th>
                                @lang("carbrand::text.id")
                            </th>
                            <th>
                                @lang("carbrand::text.name")
                            </th>
                            <th>
                                @lang("carbrand::text.slug")
                            </th>
                            <th>
                                @lang("carbrand::text.updated_at")
                            </th>
                            <th>
                                @lang("carbrand::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("carbrand::text.action")
                            </th>
                        </tr>
                    </thead>
