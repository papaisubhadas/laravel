                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <div class="float-end">
                            ...
                            <a href="{{route("backend.$module_name.destroy", $$module_name_singular)}}" class="btn btn-danger" data-method="DELETE" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('faq::labels.backend.delete')}}"><i class="fas fa-trash-alt"></i></a>
                            @endcan
