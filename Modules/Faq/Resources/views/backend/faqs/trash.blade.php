                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <a href="{{route("backend.$module_name.restore", $module_name_singular)}}" class="btn btn-warning btn-sm" data-method="PATCH" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('faq::labels.backend.restore')}}"><i class='fas fa-undo'></i> {{__('faq::labels.backend.restore')}}</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
