                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <strong>
                                    {{ $module_name_singular->customer_name }}
                                </strong>
                            </td>
                            <td>
                            ...
                            <td class="text-end">
                                <a href="{{route("backend.$module_name.restore", $module_name_singular)}}" class="btn btn-warning btn-sm" data-method="PATCH" data-token="{{csrf_token()}}" data-toggle="tooltip" title="{{__('carinquiry::labels.backend.restore')}}"><i class='fas fa-undo'></i> {{__('carinquiry::labels.backend.restore')}}</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
