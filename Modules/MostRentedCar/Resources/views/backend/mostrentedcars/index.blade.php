            ...
            <div class="col">
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            <th>
                                @lang("mostrentedcar::text.id")
                            </th>
                            <th>
                                @lang("mostrentedcar::text.name")
                            </th>
                            <th>
                                @lang("mostrentedcar::text.slug")
                            </th>
                            <th>
                                @lang("mostrentedcar::text.updated_at")
                            </th>
                            <th>
                                @lang("mostrentedcar::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("mostrentedcar::text.action")
                            </th>
                        </tr>
                    </thead>
