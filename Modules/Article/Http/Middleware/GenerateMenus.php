    ...
    public function handle($request, Closure $next)
    {
        \Menu::make('admin_sidebar', function ($menu) {
            ...
            ->data([
                ...
                'permission' => ['view_posts','add_posts','edit_posts','delete_posts','restore_posts', 'view_categories'],
            ]);
            ...
            ->data([
                ...
                'permission' => ['view_posts','add_posts','edit_posts','delete_posts','restore_posts'],
            ])
            ->link->attr([
                'class' => 'nav-link',
            ]);
