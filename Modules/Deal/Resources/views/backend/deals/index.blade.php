            ...
            <div class="col">
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            <th>
                                @lang("deal.deals.index.id")
                            </th>
                            <th>
                                @lang("deal.deals.index.name")
                            </th>
                            <th>
                                @lang("deal.deals.index.image")
                            </th>
                            <th>
                                @lang("deal.deals.index.status")
                            </th>
                            <th>
                                @lang("deal.deals.index.updated_at")
                            </th>
                            <th class="text-end">
                                @lang("deal.deals.index.action")
                            </th>
                        </tr>
                    </thead>
