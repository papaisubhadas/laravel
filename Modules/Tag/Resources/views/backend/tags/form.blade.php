<div class="row mb-3">
    <div class="col-12 col-sm-4">
        <div class="form-group">
            <?php
            $field_name = 'name';
            $field_lable = __('tag.tags.create.name');
    ...
    <div class="col-12 col-sm-4">
        <div class="form-group">
            <?php
            $field_name = 'slug';
            $field_lable = __('tag.tags.create.slug');
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
    ...
    <div class="col-12 col-sm-4">
        <div class="form-group">
            ...
            $field_lable = __('tag.tags.create.group_name');
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
...
<div class="row mb-3">
    <div class="col-8">
        <div class="form-group">
            <?php
            $field_name = 'c';
            $field_lable = __('tag.tags.create.image');
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
...
<div class="row mb-3">
    <div class="col-12">
        <div class="form-group">
            ...
            $field_lable = __('tag.tags.create.description');
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
...
<div class="row mb-3">
    <div class="col-12 col-sm-4">
        <div class="form-group">
            ...
            $field_lable = __('tag.tags.create.meta_title');
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
    ...
    <div class="col-12 col-sm-4">
        <div class="form-group">
            ...
            $field_lable = __('tag.tags.create.meta_keyword');
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
    ...
    <div class="col-12 col-sm-4">
        <div class="form-group">
            ...
            $field_lable = __('tag.tags.create.meta_description');
            $field_placeholder = $field_lable;
            $required = "";
            ?>
            {{ html()->label($field_lable, $field_name)->class('form-label') }} {!! fielf_required($required) !!}
...
<div class="row mb-3">
    <div class="col-12 col-sm-4">
        <div class="form-group">
            <?php
            $field_name = 'status';
            $field_lable = __('tag.tags.create.status');
